...
variable "v3-pub-subnet-1-association" {
    type = string
    default = aws_subnet.vpc-3-pub-subnet-1.id
    description = "public subnet-1" 
}
variable "v3-pub-subnet-2-association" {
    type = string
    default = ""
    description = "public subnet-2" 
}
variable "v3-pub-subnet-3-association" {
    type = string
    default = ""
    description = "public subnet-3" 
}
variable "v3-pub-subnet-4-association" {
    type = string
    default = ""
...
variable "v3-pri-subnet-1-association" {
    type = string
    default = aws_subnet.vpc-3-pri-subnet-1.id
    description = "private subnet-1" 
}
variable "v3-pri-subnet-2-association" {
    type = string
    default = ""
    description = "private subnet-2" 
}
variable "v3-pri-subnet-3-association" {
    type = string
    default = ""
    description = "private subnet-3" 
}
variable "v3-pri-subnet-4-association" {
    type = string
    default = ""
